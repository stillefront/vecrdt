...
const RectEditor: FC<RectEditorProps> = ({ attributes, onChange }) => {
  ...
  const handleInputChange = (key: keyof RectAttributes, value: any) => {
      ...
      <div className={styles.attributeGroup}>
        ...
        <div className={styles.attributeRow}>
          ...
          <div className={styles.inputGroup}>
            ...
            <input
              type="number"
              value={localAttributes.height || 0}
              onChange={(e) =>
