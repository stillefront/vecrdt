...
const GroupEditor: FC<GroupEditorProps> = ({ attributes, onChange }) => {
  ...
  const handleInputChange = (key: keyof GroupAttributes, value: any) => {
  ...
  return (
    <div className={styles.editorContainer}>
      ...
      <div className={styles.attributeGroup}>
        <p className={styles.attributeName}>Translate</p>
